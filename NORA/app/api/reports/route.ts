...
// Profit/Loss trend data with some negative values for visualization
...
const insights = [
  { 
    id: '1', 
    text: 'You spent 18% more than last month',
    type: 'warning',
  },
  { 
    id: '2', 
    text: 'Highest spending day: Friday',
    type: 'info',
  },
  { 
    id: '3', 
    text: 'Food accounts for 32% of expenses',
    type: 'info',
  },
  { 
    id: '4', 
    text: 'Marketing budget exceeded by 16%',
    type: 'warning',
  },
]
...
const suggestions = [
  { 
    id: '1', 
    text: 'Set a Food budget cap of $300',
    type: 'tip',
  },
  { 
    id: '2', 
    text: 'Reduce subscriptions to increase savings rate',
    type: 'tip',
  },
  { 
    id: '3', 
    text: 'Great job keeping Office costs under budget!',
    type: 'good',
  },
  { 
    id: '4', 
    text: 'Consider fuel card for 5% savings',
    type: 'tip',
  },
]
...
const categoryDrilldown = {
  ...
  'Office': {
    ...
    topMerchants: [
      { name: 'Amazon', amount: 680, count: 5 },
      { name: 'Staples', amount: 520, count: 3 },
      { name: 'Office Depot', amount: 390, count: 2 },
      { name: 'Best Buy', amount: 300, count: 2 },
    ],
  },
  'Fuel': {
    total: 1650,
    ...
    topMerchants: [
      { name: 'Shell', amount: 680, count: 12 },
      { name: 'BP', amount: 520, count: 9 },
      { name: 'Chevron', amount: 450, count: 8 },
    ],
  },
  'Marketing': {
    total: 5800,
    ...
    topMerchants: [
      { name: 'Google Ads', amount: 2800, count: 4 },
      { name: 'Facebook Ads', amount: 1800, count: 3 },
      { name: 'LinkedIn Ads', amount: 850, count: 2 },
      { name: 'Mailchimp', amount: 350, count: 1 },
    ],
  },
  'Bills': {
    total: 3200,
    ...
    topMerchants: [
      { name: 'AWS', amount: 1200, count: 1 },
      { name: 'Electricity Co', amount: 350, count: 1 },
      { name: 'Internet Provider', amount: 150, count: 1 },
      { name: 'Insurance', amount: 500, count: 1 },
    ],
  },
  'Shopping': {
    total: 1860,
    ...
    topMerchants: [
      { name: 'Amazon', amount: 780, count: 6 },
      { name: 'Target', amount: 450, count: 3 },
      { name: 'Walmart', amount: 380, count: 4 },
      { name: 'Costco', amount: 250, count: 1 },
    ],
  },
}
...
const topTransactions = [
  ...
  { id: '11', date: '2025-01-06', merchant: 'Starbucks', category: 'Food', payment: 'Cash', amount: 45, tag: 'low' },
